(function (global, factory) {
	...
	var AudioSystem_2 = AudioSystem_1.SoundAudioSystem;
	var AudioSystem_3 = AudioSystem_1.MusicAudioSystem;
	var AudioSystem_4 = AudioSystem_1.AudioSystem;
	...
	unwrapExports(Event);
	var Event_1 = Event.SeedEvent;
	var Event_2 = Event.PlayerInfoEvent;
	var Event_3 = Event.TimestampEvent;
	var Event_4 = Event.LeaveEvent;
	var Event_5 = Event.JoinEvent;
	var Event_6 = Event.OperationEvent;
	var Event_7 = Event.MessageEvent;
	var Event_8 = Event.PointMoveEventBase;
	var Event_9 = Event.PointUpEventBase;
	var Event_10 = Event.PointDownEventBase;
	var Event_11 = Event.PointEventBase;
	...
	unwrapExports(E_1);
	var E_2 = E_1.E;
	var E_3 = E_1.PointMoveEvent;
	var E_4 = E_1.PointUpEvent;
	var E_5 = E_1.PointDownEvent;
	...
	var AssetConfiguration = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(AssetConfiguration);

	var AssetLoadFailureInfo = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(AssetLoadFailureInfo);
	...
	var AssetManagerLoadHandler = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(AssetManagerLoadHandler);
	...
	var TimerManager_2 = TimerManager_1.TimerManager;
	var TimerManager_3 = TimerManager_1.TimerIdentifier;
	...
	var DynamicAssetConfiguration = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(DynamicAssetConfiguration);
	...
	var Storage_3 = Storage_1.StorageLoader;
	var Storage_4 = Storage_1.StorageValueStore;
	var Storage_5 = Storage_1.StorageCountsOperation;
	var Storage_6 = Storage_1.StorageCondition;
	var Storage_7 = Storage_1.StorageOrder;
	var Storage_8 = Storage_1.StorageRegion;
	...
	var EventFilter = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(EventFilter);

	var EventFilterController = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(EventFilterController);
	...
	var GameConfiguration = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(GameConfiguration);

	var GameMainParameterObject = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(GameMainParameterObject);

	var LocalTickModeString = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(LocalTickModeString);
	...
	var OperationPlugin = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(OperationPlugin);

	var OperationPluginInfo = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(OperationPluginInfo);
	...
	var OperationPluginOperation = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(OperationPluginOperation);

	var OperationPluginStatic = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(OperationPluginStatic);
	...
	var RequireCacheable = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(RequireCacheable);
	...
	var SurfaceEffector = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(SurfaceEffector);

	var TextAlignString = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(TextAlignString);

	var TextMetrics = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(TextMetrics);

	var TickGenerationModeString = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(TickGenerationModeString);
	...
	__exportStar(AudioSystem_1, exports);
	__exportStar(CacheableE_1, exports);
	__exportStar(E_1, exports);
	__exportStar(FilledRect_1, exports);
	__exportStar(FrameSprite_1, exports);
	__exportStar(Label_1, exports);
	__exportStar(Pane_1, exports);
	__exportStar(Sprite_1, exports);
	__exportStar(AssetAccessor_1, exports);
	__exportStar(AssetConfiguration, exports);
	__exportStar(AssetLoadFailureInfo, exports);
	__exportStar(AssetManager_1, exports);
	__exportStar(AssetManagerLoadHandler, exports);
	__exportStar(AudioSystemManager_1, exports);
	__exportStar(BitmapFont_1, exports);
	__exportStar(Camera, exports);
	__exportStar(Camera2D_1, exports);
	__exportStar(Collision_1, exports);
	__exportStar(DefaultLoadingScene_1, exports);
	__exportStar(DynamicAssetConfiguration, exports);
	__exportStar(DynamicFont_1, exports);
	__exportStar(EntityStateFlags, exports);
	__exportStar(Event, exports);
	__exportStar(EventConverter_1, exports);
	...
	__exportStar(ExceptionFactory_1, exports);
	__exportStar(Font_1, exports);
	__exportStar(GameConfiguration, exports);
	__exportStar(GameMainParameterObject, exports);
	__exportStar(LoadingScene_1, exports);
	__exportStar(LocalTickModeString, exports);
	__exportStar(Matrix, exports);
	__exportStar(Module_1, exports);
	__exportStar(ModuleManager_1, exports);
	__exportStar(NinePatchSurfaceEffector_1, exports);
	__exportStar(Object2D_1, exports);
	__exportStar(OperationPlugin, exports);
	__exportStar(OperationPluginInfo, exports);
	__exportStar(OperationPluginManager_1, exports);
	__exportStar(OperationPluginOperation, exports);
	__exportStar(OperationPluginStatic, exports);
	__exportStar(PathUtil_1, exports);
	__exportStar(Player, exports);
	__exportStar(PointEventResolver_1, exports);
	__exportStar(RandomGenerator_1, exports);
	__exportStar(RequireCacheable, exports);
	__exportStar(RequireCachedValue_1, exports);
	__exportStar(ScriptAssetContext_1, exports);
	__exportStar(ShaderProgram_1, exports);
	__exportStar(SpriteFactory_1, exports);
	__exportStar(Storage_1, exports);
	__exportStar(SurfaceAtlas_1, exports);
	__exportStar(SurfaceAtlasSet_1, exports);
	__exportStar(SurfaceAtlasSlot_1, exports);
	__exportStar(SurfaceEffector, exports);
	__exportStar(SurfaceUtil_1, exports);
	__exportStar(TextAlign_1, exports);
	__exportStar(TextAlignString, exports);
	__exportStar(TextMetrics, exports);
	__exportStar(TickGenerationModeString, exports);
	__exportStar(Timer_1, exports);
	__exportStar(TimerManager_1, exports);
	__exportStar(Util_1, exports);
	__exportStar(VideoSystem_1, exports);
	__exportStar(Xorshift_1, exports);
	__exportStar(XorshiftRandomGenerator_1, exports);
	__exportStar(Scene_1, exports);
	__exportStar(Game_1, exports);
	});

	unwrapExports(index_common);

	var GameHandlerSet = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(GameHandlerSet);
	...
	__exportStar(GameHandlerSet, exports); // NOTE: コンテンツから参照する必要はない
	});
